...
if __name__ == '__main__':
    sample = '{"key1" : 123}'
    print("1" , json_parser(sample)) 
    sample = '{"key1" : [1,2]}'
    print("2" , json_parser(sample))
    sample = '{"key1" : [1,,,2]}'
    print("3" , json_parser(sample)) 
    sample = '{"key1" : [1,"2"]}'
    print("3.b" , json_parser(sample)) 
    sample = '{"key1" : "value1", "key2" : ["value2", "value3"], "key3" : { "subkey1" : "123" }, "key4":["x"] }'
    sample = '{"key1" : "value1", "key2" : ["value2", "value3"], "key3" : { "subkey1" : "123" }, "key4":["x"] }'
    print("4" , json_parser(sample)) 
    sample = '{"key1" : "value1", "key2" : ["value2", "value3"], "key3" : { "subkey1" : "123" } }'
    print("5" , json_parser(sample)) 
    sample = '{"key1" : "value1", "key2" : ["value2", "value3"], "key3" : { "subkey1" : 123 } }'
    print("6" , json_parser(sample)) 
    sample = '{"key0":{"key1" : "value1", "key2" : [], "key3" : {} }}'
    print("7" , json_parser(sample)) 
